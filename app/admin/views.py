...
def biografia():
    if ('token' in session):
        biografiaData = fb.getDocument('Biografia','aGpO9zoLAnNzTJJwtyfc')
        ...
        if biografia_form.validate_on_submit():
            ...
            resultadoUpdateBiografia = fb.updateDocument('Biografia','aGpO9zoLAnNzTJJwtyfc',dataBiografiaActualizada)
